...
class ListFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            param1 = it.getString(com.example.cit_238_dualpane.ARG_PARAM1)
            param2 = it.getString(com.example.cit_238_dualpane.ARG_PARAM2)
        }
    }
        ...
        fun newInstance(param1: String, param2: String) =
            ListFragment().apply {
                arguments = Bundle().apply {
                    putString(com.example.cit_238_dualpane.ARG_PARAM1, param1)
                    putString(com.example.cit_238_dualpane.ARG_PARAM2, param2)
                }
            }
    }
}